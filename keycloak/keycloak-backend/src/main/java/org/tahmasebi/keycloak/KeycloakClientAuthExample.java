...
public class KeycloakClientAuthExample {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Token : " + facade.getAccessTokenString());
...
//    System.out.println(facade.getAccessToken());
        ...
        AccessToken accessToken = facade.getAccessToken("admin", "admin");
        System.out.println("Decoded Access Token : " + accessToken.getPreferredUsername());
    }
    ...
    static class KeycloakClientFacade {
        ...
        public KeycloakClientFacade(String serverUrl, String realmId, String clientId, String username,String password) {
